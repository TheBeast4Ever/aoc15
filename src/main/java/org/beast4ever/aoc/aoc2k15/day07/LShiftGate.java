...
@Slf4j
public class LShiftGate extends LogicalGate {

    private int pad;

    public LShiftGate(int lpad) {
        this.pad = lpad;
    }
    ...
    public Signal executeInstruction(Signal... signals) {
        ...
        log.debug("Execute LShift instruction on {} with pad {}. Result is : {}", inputSignal, pad, outputSignal);
        return outputSignal;
    }
    @Override
